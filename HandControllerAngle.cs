    ...
    void Start()
{
    ...
    void calculateNewDirections()
    {
        ...
        thumb.midDirection.forward = baseDirection.forward;
        ...
        thumb.midDirection.up = Vector3.Cross(thumb.midDirection.forward, thumb.midDirection.right);

        thumb.basDirection.forward = baseDirection.forward;
        ...
        thumb.basDirection.up = Vector3.Cross(thumb.basDirection.forward, thumb.basDirection.right);

        Debug.DrawRay(rightHand.transform.GetChild(0).transform.position, thumb.basDirection.forward, Color.white);
        Debug.DrawRay(rightHand.transform.GetChild(0).transform.position, thumb.basDirection.right, Color.red);
        Debug.DrawRay(rightHand.transform.GetChild(0).transform.position, thumb.basDirection.up, Color.blue);
        ...
        index.midDirection.right = (new Vector3(client.handCooArray[48], client.handCooArray[49], client.handCooArray[50]) - new Vector3(client.handCooArray[45], client.handCooArray[46], client.handCooArray[47])) * (-1);
        index.midDirection.up = Vector3.Cross(index.midDirection.forward, index.midDirection.right);
        ...
        middle.midDirection.right = (new Vector3(client.handCooArray[36], client.handCooArray[37], client.handCooArray[38]) - new Vector3(client.handCooArray[33], client.handCooArray[34], client.handCooArray[35])) * (-1);
        middle.midDirection.up = Vector3.Cross(middle.midDirection.forward, middle.midDirection.right);
        ...
        ring.tipDirection.up = Vector3.Cross(ring.tipDirection.forward, ring.tipDirection.right);

        ring.midDirection.forward = baseDirection.forward;
        ring.midDirection.right = (new Vector3(client.handCooArray[24], client.handCooArray[25], client.handCooArray[26]) - new Vector3(client.handCooArray[21], client.handCooArray[22], client.handCooArray[23])) * (-1);
        ring.midDirection.up = Vector3.Cross(ring.midDirection.forward, ring.midDirection.right);
        ...
        pinky.tipDirection.up = Vector3.Cross(pinky.tipDirection.forward, pinky.tipDirection.right);

        pinky.midDirection.forward = baseDirection.forward;
        pinky.midDirection.right = (new Vector3(client.handCooArray[12], client.handCooArray[13], client.handCooArray[14]) - new Vector3(client.handCooArray[9], client.handCooArray[10], client.handCooArray[11])) * (-1);
        pinky.midDirection.up = Vector3.Cross(pinky.midDirection.forward, pinky.midDirection.right);
    ...
    void updateBaseDir()
    {
        ...
        //Thumb
        rightHand.transform.GetChild(0).rotation = Quaternion.LookRotation((thumb.basDirection.forward + (thumb.basDirection.forward - thumb.basDirection.right)), -1 * thumb.basDirection.up); //base
        //Index
    ...
    void updateTipDir()
    {
        ...
        handFingers.finger[0][1].transform.rotation = Quaternion.LookRotation((thumb.tipDirection.forward + (thumb.tipDirection.forward - thumb.tipDirection.right)), -1 * thumb.tipDirection.up);
        //Index
    ...
    {
        //Thumb
        handFingers.finger[0][0].transform.rotation = Quaternion.LookRotation((thumb.midDirection.forward + (thumb.midDirection.forward - thumb.midDirection.right)), -1 * thumb.midDirection.up);
        //Index
